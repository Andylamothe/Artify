import { ARObjectConfig, ArtworkConfig } from "@/types/ar";

const starryNightWorkbenchObjects: ARObjectConfig[] = [
  {
    id: "starry-layer-base",
    name: "Base painting layer",
    type: "image",
    text: "",
    src: "/ar/artworks/starry-night/base.webp",
    icon: "",
    actionType: "none",
    actionUrl: "",
    color: "#ffffff",
  ...
  {
    id: "starry-layer-sky",
    name: "Animated sky layer",
    type: "image",
    text: "",
    src: "/ar/artworks/starry-night/sky-layer.webp",
    icon: "",
    actionType: "none",
    actionUrl: "",
    color: "#5A83E5",
    ...
    width: 1.38,
    height: 1.04,
    position: { x: 0, y: 0.08, z: 0.28 },
    rotation: { x: 0, y: 0, z: -2 },
    scale: { x: 1, y: 1, z: 1 },
  },
  {
    id: "starry-layer-stars",
    name: "Star glow layer",
    type: "image",
    text: "",
    src: "/ar/artworks/starry-night/stars-layer.webp",
    icon: "",
    actionType: "none",
    actionUrl: "",
    color: "#F7C948",
    ...
    width: 1.52,
    height: 1.14,
    position: { x: 0.02, y: 0.08, z: 0.36 },
    rotation: { x: 0, y: 0, z: 1 },
    scale: { x: 1, y: 1, z: 1 },
  },
  {
    id: "starry-layer-moon",
    name: "Moon glow",
    type: "image",
    text: "",
    src: "/ar/artworks/starry-night/moon-glow.webp",
    icon: "",
    actionType: "none",
    actionUrl: "",
    color: "#F7C948",
    ...
    width: 0.48,
    height: 0.36,
    position: { x: 0.48, y: 0.38, z: 0.46 },
    rotation: { x: 0, y: 0, z: 0 },
    scale: { x: 1, y: 1, z: 1 },
  },
  {
    id: "starry-brush-main-swirl",
    name: "Main sky swirl brush",
    type: "brush",
    text: "",
    src: "",
    icon: "",
    ...
    width: 0.86,
    height: 0.38,
    position: { x: -0.2, y: 0.19, z: 0.58 },
    rotation: { x: 0, y: 0, z: 0 },
    scale: { x: 1, y: 1, z: 1 },
  },
  {
    id: "starry-brush-yellow-stars",
    name: "Yellow star pulse brush",
    type: "brush",
    text: "",
    src: "",
    icon: "",
    ...
    width: 1.14,
    height: 0.2,
    position: { x: 0.04, y: 0.45, z: 0.62 },
    rotation: { x: 0, y: 0, z: 0 },
    scale: { x: 1, y: 1, z: 1 },
  },
  {
    id: "starry-panel-portfolio",
    name: "Portfolio AR button",
    type: "button",
    text: "Portfolio",
    src: "",
    icon: "i",
    ...
    width: 0.72,
    height: 0.24,
    position: { x: -0.72, y: -0.62, z: 0.72 },
    rotation: { x: 0, y: 0, z: 0 },
    scale: { x: 1, y: 1, z: 1 },
  },
  {
    id: "starry-panel-history",
    name: "History AR button",
    type: "button",
    text: "History",
    src: "",
    icon: "H",
...
export const artworks: ArtworkConfig[] = [
  ...
  },
  {
    ...
    effects: {
      particleCount: 60,
      lowPowerParticleCount: 24,
      intensity: "medium",
    },
    arObjects: starryNightWorkbenchObjects,
  },
  {
    id: "the-scream",
    title: "The Scream",
